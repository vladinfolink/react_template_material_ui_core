...
class Test extends Component {
	...
	static getDerivedStateFromProps(nextProps, prevState) {//FIXME: mounting + TODO: updating															1			=>5
	...
	shouldComponentUpdate(nextProps, nextState, nextContext) { //TODO: (UPDATE) => allows cancelling the updating process				=>6
																													 console.log('shouldComponentUpdate');
								// continue update ? return true : return false; => compare this.props with nextProps
		return true
	}

	getSnapshotBeforeUpdate(prevProps, prevState){//TODO:  (UPDATE)																															=>9
	...
	componentDidUpdate(prevProps, prevState, snapshot) {//TODO:  (UPDATE)																																	=>10
	...
	componentDidMount() { //FIXME: mounting										==>CAUSE SIDE EFFECT, DON'T CALL setState()	SYNCHRONOUSLY		4
	...
	render() {//FIXME: mounting + updating TODO:																																					2			=>7
